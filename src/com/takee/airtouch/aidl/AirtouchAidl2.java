 ...
 * Original file: E:\\my_workspace\\takee_airtouch\\src\\com\\takee\\airtouch\\aidl\\AirtouchAidl2.aidl
 */
 ...
 * @author bao
 */
public interface AirtouchAidl2 extends android.os.IInterface {
	/** Local-side IPC implementation stub class. */
	public static abstract class Stub extends android.os.Binder implements
			com.takee.airtouch.aidl.AirtouchAidl2 {
		private static final java.lang.String DESCRIPTOR = "com.takee.airtouch.aidl.AirtouchAidl2";
		...
		/**
		 * Cast an IBinder object into an com.takee.airtouch.aidl.AirtouchAidl2
		 * interface, generating a proxy if needed.
		 */
		public static com.takee.airtouch.aidl.AirtouchAidl2 asInterface(
				android.os.IBinder obj) {
			if ((obj == null)) {
				return null;
			}
			android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
			if (((iin != null) && (iin instanceof com.takee.airtouch.aidl.AirtouchAidl2))) {
				return ((com.takee.airtouch.aidl.AirtouchAidl2) iin);
			}
			return new com.takee.airtouch.aidl.AirtouchAidl2.Stub.Proxy(obj);
		}
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_getAirTouchDeviceList: {
				...
				java.util.List<android.bluetooth.BluetoothDevice> _result = this
						.getAirTouchDeviceList(_arg0);
				reply.writeNoException();
			...
			case TRANSACTION_setOnGestureChangedListener: {
				data.enforceInterface(DESCRIPTOR);
				com.takee.airtouch.aidl.OnGestureChangedListener _arg0;
				_arg0 = com.takee.airtouch.aidl.OnGestureChangedListener.Stub
						.asInterface(data.readStrongBinder());
				boolean _result = this.setOnGestureChangedListener(_arg0);
				reply.writeNoException();
				reply.writeInt(((_result) ? (1) : (0)));
				return true;
			}
			case TRANSACTION_setOnPositionChangedListener: {
				data.enforceInterface(DESCRIPTOR);
				com.takee.airtouch.aidl.OnPositionChangedListener _arg0;
				_arg0 = com.takee.airtouch.aidl.OnPositionChangedListener.Stub
						.asInterface(data.readStrongBinder());
				int _result = this.setOnPositionChangedListener(_arg0);
				reply.writeNoException();
				reply.writeInt(_result);
				return true;
			}
		...
		private static class Proxy implements
			 ...
			 */
			@Override
			public boolean setAirTouchEnable(boolean isenable)
					throws android.os.RemoteException {
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setAirTouchEnable, _data,
							_reply, 0);
			 ...
			 */
			@Override
			public boolean getAirTouchIsEnable()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getAirTouchIsEnable,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public int[] getCursorPosition() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getCursorPosition, _data,
							_reply, 0);
					_reply.readException();
			...
			public int openAirtouch() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_openAirtouch, _data,
							_reply, 0);
					_reply.readException();
			...
			public int openOuterAirtouch() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_openOuterAirtouch, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 */
			@Override
			public boolean closeOuterAirtouch()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_closeOuterAirtouch,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public int openInnerAirtouch() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_openInnerAirtouch, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 */
			@Override
			public boolean closeInnerAirtouch()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_closeInnerAirtouch,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean releaseAirTouch() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_releaseAirTouch, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public int getOuterAirTouchState()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getOuterAirTouchState,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 */
			@Override
			public int getInnerAirTouchState()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getInnerAirTouchState,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 */
			@Override
			public int getCurrentAirTouchSensor()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getCurrentAirTouchSensor,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public boolean applyUseGesture() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_applyUseGesture, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean closeGestureUse() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_closeGestureUse, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public boolean setAirTouchMode(int modeType)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setAirTouchMode, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public int getCurrentAirTouchMode()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getCurrentAirTouchMode,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getAirTouchGesture() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getAirTouchGesture,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public boolean setCursorDown() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_setCursorDown, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean setCursorUp() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_setCursorUp, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public boolean setCursorClick() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_setCursorClick, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public int getCursorAction() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getCursorAction, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 *         <p>
			 *         返回名字类似于Takee_Air_Touch_00的设备列表
			 *         <p>
			 *         如：
			 *         <p>
			 *         "Takee_Air_Touch_001"
			 ...
			 *         "Takee_Air_Touch_002"
			 *         <p>
			 *         "Takee_Air_Touch_0011"
			 */
			@Override
			public java.util.List<android.bluetooth.BluetoothDevice> getAirTouchDeviceList(
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_getAirTouchDeviceList,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply
							.createTypedArrayList(android.bluetooth.BluetoothDevice.CREATOR);
				} finally {
					_reply.recycle();
					_data.recycle();
				}
			 ...
			 */
			@Override
			public boolean correctionPosition(int[] position)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_correctionPosition,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 * @param int
			 *        <p>
			 *        automicState = 0 不自动判断
			 *        <p>
			 *        automicState = 1 自动判断 down 和 up 消息
			 *        <p>
			 *        automicState = 2 自动判断 click 消息
			 * @return boolean
			 *         <p>
			 *         调用成功： true
			 *         <p>
			 ...
			 */
			@Override
			public boolean setAutomicState(int state)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_setAutomicState, _data,
							_reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public int getAutomicState() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getAutomicState, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			 ...
			 */
			@Override
			public boolean changeAirtouchAddress(java.lang.String address)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_changeAirtouchAddress,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public boolean sendCommandToAirtouch(byte command, byte[] params)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					...
					mRemote.transact(Stub.TRANSACTION_sendCommandToAirtouch,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public byte[] getResponseForAirtouch()
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				byte[] _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getResponseForAirtouch,
							_data, _reply, 0);
					_reply.readException();
			 ...
			 * 设置空中触控手势改变监听
			 * 
			 * @param OnGestureChangeListener
			 */
			@Override
			public boolean setOnGestureChangedListener(
					com.takee.airtouch.aidl.OnGestureChangedListener onGestureChangedListener)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				boolean _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeStrongBinder((((onGestureChangedListener != null)) ? (onGestureChangedListener
							.asBinder()) : (null)));
					mRemote.transact(
							Stub.TRANSACTION_setOnGestureChangedListener,
							_data, _reply, 0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			 ...
			 */
			@Override
			public int setOnPositionChangedListener(
					com.takee.airtouch.aidl.OnPositionChangedListener onPositionChangedListener)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				int _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeStrongBinder((((onPositionChangedListener != null)) ? (onPositionChangedListener
							.asBinder()) : (null)));
					mRemote.transact(
							Stub.TRANSACTION_setOnPositionChangedListener,
							_data, _reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
		...
		static final int TRANSACTION_setOnGestureChangedListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
		static final int TRANSACTION_setOnPositionChangedListener = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
	}
